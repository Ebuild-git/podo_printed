...
<div class="row g-6">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <input type="text" wire:model="titre1_impression" placeholder="Le titre " rows="3" class="form-control">
            @error('titre1_impression')
            <span class="text-danger small"> {{ $message }} </span>
            @enderror
        </div>
        <div class="col-md-4">
            ...
            <textarea type="text" wire:model="desc1_impression" placeholder="description" rows="3" class="form-control"> </textarea>
            @error('desc1_impression')
            <span class="text-danger small"> {{ $message }} </span>
            @enderror
        </div>

        <div class="col-md-4">
            <label class="form-label" for="multicol-username">Icon(100*100)</label>

            <input type="file" wire:model="image1_impression" accept="image/*" placeholder="votre icon" class="form-control">
            @error('image1_impression')
            <span class="text-danger small"> {{ $message }} </span>
            @enderror
        </div>
    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <input type="text" wire:model="titre2_impression" placeholder="Le titre " rows="3" class="form-control">
            @error('titre2_impression')
            <span class="text-danger small"> {{ $message }} </span>
            @enderror
        </div>
        <div class="col-md-4">
            ...
            <textarea type="text" wire:model="desc2_impression" placeholder="description" rows="3" class="form-control"> </textarea>
            @error('desc2_impression')
            <span class="text-danger small"> {{ $message }} </span>
            @enderror
        </div>
        ...
        <div class="col-md-4">
            ...
            <input type="file" wire:model="image2_impression" accept="image/*" placeholder="votre icon" class="form-control">
            @error('image2_impression')
            <span class="text-danger small"> {{ $message }} </span>
            @enderror
        </div>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <input type="text" wire:model="titre3_impression" placeholder="Le titre " rows="3" class="form-control">
            @error('titre3_impression')
            <span class="text-danger small"> {{ $message }} </span>
            @enderror
        </div>
        <div class="col-md-4">
            ...
            <textarea type="text" wire:model="desc3_impression" placeholder="description" rows="3" class="form-control"> </textarea>
            @error('desc3_impression')
            <span class="text-danger small"> {{ $message }} </span>
            @enderror
        </div>
        ...
        <div class="col-md-4">
            ...
            <input type="file" wire:model="image3_impression" accept="image/*" placeholder="votre icon" class="form-control">
            @error('image3_impression')
            <span class="text-danger small"> {{ $message }} </span>
            @enderror
        </div>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <input type="text" wire:model="titre4_impression" placeholder="Le titre " rows="3" class="form-control">
            @error('titre4_impression')
            <span class="text-danger small"> {{ $message }} </span>
            @enderror
        </div>
        ...
        <div class="col-md-4">
            ...
            <textarea type="text" wire:model="desc4_impression" placeholder="description" rows="3" class="form-control"> </textarea>
            @error('desc4_impression')
            <span class="text-danger small"> {{ $message }} </span>
            @enderror
        </div>
        ...
        <div class="col-md-4">
            ...
            <input type="file" wire:model="image4_impression" accept="image/*" placeholder="votre icon" class="form-control">
            @error('image4_impression')
            <span class="text-danger small"> {{ $message }} </span>
            @enderror
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <input type="text" wire:model="titre5_impression" placeholder="Le titre " rows="3" class="form-control">
            @error('titre5_impression')
            <span class="text-danger small"> {{ $message }} </span>
            @enderror
        </div>
        ...
        <div class="col-md-4">
            ...
            <textarea type="text" wire:model="desc5_impression" placeholder="description" rows="3" class="form-control"> </textarea>
            @error('desc5_impression')
            <span class="text-danger small"> {{ $message }} </span>
            @enderror
        </div>
        ...
        <div class="col-md-4">
            ...
            <input type="file" wire:model="image5_impression" accept="image/*" placeholder="votre icon" class="form-control">
            @error('image5_impression')
            <span class="text-danger small"> {{ $message }} </span>
            @enderror
        </div>
    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <input type="text" wire:model="titre6_impression" placeholder="Le titre " rows="3" class="form-control">
            @error('titre5_impression')
            <span class="text-danger small"> {{ $message }} </span>
            @enderror
        </div>
        ...
        <div class="col-md-4">
            ...
            <textarea type="text" wire:model="desc6_impression" placeholder="description" rows="3" class="form-control"> </textarea>
            @error('desc6_impression')
            <span class="text-danger small"> {{ $message }} </span>
            @enderror
        </div>
        ...
        <div class="col-md-3">
            ...
            <input type="file" wire:model="image6_impression" accept="image/*" placeholder="votre icon" class="form-control">
            @error('image6_impression')
            <span class="text-danger small"> {{ $message }} </span>
            @enderror
        </div>
