    ...
    <div class="card bg-transparent shadow-none my-6 border-0">
        <div class="card-body row p-0 pb-6 g-6">
            <div class="col-12 col-lg-8 card-separator">
                <h5 class="mb-2">Content de vous revoir,<span class="h4"> PODO PRINTED 👋🏻</span></h5>
                ...
                <div class="d-flex justify-content-between flex-wrap gap-4 me-12">
                    ...
                    <div class="d-flex align-items-center gap-4">
                        ...
                        <div class="content-right">
                            <p class="mb-0 fw-medium">Total  Docteurs</p>
                    ...
                    <div class="d-flex align-items-center gap-4">
                        ...
                        <div class="content-right">
                            <p class="mb-0 fw-medium">Total  Actualités</p>
        ...
        <div class="col-xxl-4 col-lg-6">
            <div class="card h-100">
                <div class="card-header d-flex align-items-center justify-content-between">
                    <h5 class="card-title m-0 me-2">Les rescentes actualités</h5>
                    <div class="dropdown">
                        {{-- <button
        ...
        <div class="col-xxl-4 col-md-6">
            ...
            <div class="card h-100">
                ...
                <div class="card-body">
                    ...
                    <a href="javascript:void(0);" class="btn btn-primary w-100">Actulité  en cours
                        </a>
                </div>  
                @endif
